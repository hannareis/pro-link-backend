...
$router->get('/posts', [PostController::class, 'index'], [AuthMiddleware::class]);
$router->get('/posts/{id}', [PostController::class, 'show'], [AuthMiddleware::class]);
$router->post('/posts', [PostController::class, 'store'], [AuthMiddleware::class, SanitizeInputMiddleware::class, CsrfMiddleware::class]);
$router->post('/posts/edit/{id}', [PostController::class, 'update'], [AuthMiddleware::class, SanitizeInputMiddleware::class, CsrfMiddleware::class]);
